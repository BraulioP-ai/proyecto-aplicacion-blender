...
GRAMATICA  = os.path.join(DIRECTORIO, "terreno2.gic")
METACOMP   = os.path.join(DIRECTORIO, "metacompilador_terreno2.py")
PARSER     = os.path.join(DIRECTORIO, "parser_terreno2.py")
