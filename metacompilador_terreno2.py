...
def generar_script_blender(bioma, variante, agua):
    ...
    lineas = [
        ...
        "",
        "# 3. Deformar con Ruido de Perlin",
        ...
        "",
        "    # Magia de biomas especiales",
        "    if '" + bioma + "' == 'k':",
        "        # Cañones: Usamos valor absoluto para crear grietas afiladas hacia abajo",
        "        altura = abs(valor) * amplitud",
        "    else:",
        "        # Terreno normal",
        "        altura = ((valor + 1.0) / 2.0) * amplitud",
        "",
        "    if '" + bioma + "' == 'p' and altura > amplitud * 0.55:",
        "        # Mesetas: Cortar la cima si pasa del 55% de la amplitud",
        "        altura = amplitud * 0.55",
        "",
...
def main():
    ...
    print("    bioma   -> m=Montana  v=Valle  l=Llanura  h=Colinas  k=Canones  p=Meseta  d=Dunas")
...
def parse():
    if S() and w[p] == "\\n":
        ...
        print("Codigo invalido. Formato esperado: [m/v/l/h/k/p/d]([e.../s...],[c/a])")
